      ...
      <div className="relative w-full max-w-2xl bg-slate-900 border border-slate-700/80 rounded-3xl shadow-2xl overflow-hidden z-10 my-8 animate-fade-in">
        ...
        <div className="p-6 space-y-6 max-h-[calc(85vh-12rem)] overflow-y-auto custom-scrollbar">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-slate-950/60 p-3.5 rounded-xl border border-slate-800/80 text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
              ...
              <div className="text-right">
                ...
                <span className="font-mono font-bold text-emerald-300 text-sm">
                  {contactPreferences.whatsapp || contactPreferences.phone || 'Available on request'}
                </span>
              </div>
            </div>
          </div>
